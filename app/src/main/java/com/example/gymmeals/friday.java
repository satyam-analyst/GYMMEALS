...
public class friday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter adapter1=new ArrayAdapter(friday.this,android.R.layout.simple_list_item_1,data1);
        spin1.setAdapter(adapter1);
        ArrayAdapter adapter2=new ArrayAdapter(friday.this,android.R.layout.simple_list_item_1,data2);
        spin2.setAdapter(adapter2);
        ArrayAdapter adapter3=new ArrayAdapter(friday.this,android.R.layout.simple_list_item_1,data3);
